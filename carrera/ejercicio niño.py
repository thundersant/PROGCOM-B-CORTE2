...
#importamos pygame que sirve para juegos en python, random para los objetos, la hora para saber el dia y hora que intentamos la partida
...
#Ponemos el tamaño de la ventama, nombre de la app que ejecutara 

SCREENWIDTH=800
SCREENHEIGHT=500
size = (SCREENWIDTH, SCREENHEIGHT)
screen = pygame.display.set_mode(size)
pygame.display.set_caption("Carrera niño")
...
#insertamos la imagen del menú 

menuBg = pygame.image.load(directory + "\\img\\menu.png").convert_alpha()

#Agregamos la fuente de la letra que usaremos para el texto, y el tamaño de esta

myfont = pygame.font.SysFont('Lucida Console', 20)

#ingresamos las variables globales, el nombre, la energia que seria la vida
#los puntos que llevamos, fecha, la velocidad, entre otros
...
#Sonidos dentro de la partida, cuando cogemos los dulces, choques y cuando perdemos 


soundCrash = pygame.mixer.Sound(directory + "\\sounds\\choque.wav")
soundPoints = pygame.mixer.Sound(directory + "\\sounds\\mordisco.wav")
soundGameOver = pygame.mixer.Sound(directory + "\\sounds\\perdedor.wav")

#creamos las clases, instancias y grupos 
...
class enemy(pygame.sprite.Sprite):
    ...
    def __init__(self, kind, lane):
        ...
        self.image = pygame.transform.rotate(pygame.transform.scale(pygame.image.load(directory + "\\img\\zombie.png").convert_alpha(),self.size),180)
        ...
        if self.kind == 1:
            self.image = pygame.image.load(directory + "\\img\\zombie.png").convert_alpha()
        elif self.kind == 2:
            self.image = pygame.image.load(directory + "\\img\\zombie_m.png").convert_alpha()
        elif self.kind == 3:
            self.image = pygame.image.load(directory + "\\img\\zombie_f.png").convert_alpha()
        elif self.kind == 4:
            self.image = pygame.image.load(directory + "\\img\\barril_1.png").convert_alpha()
        elif self.kind == 5:
            self.image = pygame.image.load(directory + "\\img\\arbol_1.png").convert_alpha()
        elif self.kind == 6:
            self.image = pygame.image.load(directory + "\\img\\droga_1.png").convert_alpha()
...
class thing(pygame.sprite.Sprite):
    ...
    def __init__(self, lane):
        ...
        self.image = pygame.image.load(directory + "\\img\\caramelo.png").convert_alpha()
        self.rect = self.image.get_rect()
...
class kar(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(directory + "\\img\\humano_1.png").convert_alpha()
        self.rect = self.image.get_rect()
        self.rect.x = 400
        self.rect.y = 400
...
class landscape(pygame.sprite.Sprite):
    ...
    def __init__(self, y):
        ...
        self.image = pygame.image.load(directory + "\\img\\mapa.png").convert_alpha()
        self.rect = self.image.get_rect() 
        self.rect.y = y
...
class InputBox:
    ...
    def update(self):
        # cambia el tamaño del texto si es demasiado largo 
...
def playMusic(music):
    ...
    if music == "main":
        pygame.mixer.music.load(directory + "\\sounds\\musi.wav")
        pygame.mixer.music.play(-1)
        
    elif music == "correr":
        pygame.mixer.music.load(directory + "\\sounds\\correr.wav")
...
#guardar los datos del jugador: nombre, puntos, energia(vida)
...
def instructions():
    ...
    label1 = myfont.render("- corre por la autopista sin tropezar", 1, WHITE, BLUE)
    label2 = myfont.render("- Usa las teclas A y D del teclado para mover tú personaje", 1, WHITE, BLUE)
    label3 = myfont.render("- Usa F para modo completo(en arreglo) :)", 1, WHITE, BLUE)
    label4 = myfont.render("- Consigue todos los dulces posibles antes de que te atrapen", 1, WHITE, BLUE)
...
def enterName():
    ...
    labelEnterName = myfont.render("Ingrese el nombre del corredor:", 1, BLUE)
